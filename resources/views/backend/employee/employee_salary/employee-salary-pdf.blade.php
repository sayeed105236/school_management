			...
			<div class="col-md-12"></div>
				...
				<table width="80%" border="">
					<tr>
						...
						<td> <img src="{{url('public/upload/employee_images/'.$totalattendgroupbyid['0']['user']['image'])}}" style="width: 100px; height: 100px"></td>
					</tr>
				</table>
		</div>

		<div class="col-md-12">
			<h5 class="text-center" style="font-weight: bold; padding-top:-25px"> Employee Monthly Salary </h5>
		</div>
