            ...
            <div class="card">
              <div class="card-header">
               ...
               <h3>
                ...
                Add About Us
                @endif
                <a class="btn btn-success float-right btn-sm" href="{{route('web-site.about.view')}}"><i class="fa fa-list"></i> About Us List</a>

               </h3>

              </div><!-- /.card-header -->
              <div class="card-body">
                <form method="post" action="{{(@$editData)?route('web-site.about.update',$editData->id):route('web-site.about.store')}}" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
