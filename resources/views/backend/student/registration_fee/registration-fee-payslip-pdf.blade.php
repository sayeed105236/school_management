...
<div class="container">
		...
		<div class="col-md-12">
			<h5 class="text-center" style="font-weight: bold; padding-top:-25px"> Student Registration Fee</h5>
		</div>
		...
		<div class="col-md-12">
			...
			<table  width="100%" class="table-bordered">
				<tbody>
					...
					<tr>
						<td style="width: 50px"> Registration Fee </td>
					...
					<tr>
						<td style="width: 50px">  Fee (This student) of Registration Fee </td>
						<td>{{$finalfee}} TK </td>
					</tr>
	...
	<table width="80%" border="">
					<tr>
						...
						<td class="text-center" width="63%">
							...
							<h5><strong>Mithpukur, Rangpur</strong></h5>
							<h4><strong>E-mail</strong></h4>
						</td>
