          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
               ...
               <h3> Edit Group
                <a class="btn btn-success float-right btn-sm" href="{{route('setups.group.view')}}"><i class="fa fa-list"></i>Classr List</a>
              ...
              <form method="post" action="{{route('setups.group.update',$editData->id)}}" id="myForm">
