          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
               ...
               <h3> Add Group
                <a class="btn btn-success float-right btn-sm" href="{{route('setups.group.view')}}"><i class="fa fa-list"></i>Group List</a>
              ...
              <form method="post" action="{{route('setups.group.store')}}" id="myForm">
