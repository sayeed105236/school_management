          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
               ...
               <h3> Edit Class
                <a class="btn btn-success float-right btn-sm" href="{{route('setups.student.class.view')}}"><i class="fa fa-list"></i>Classr List</a>
              ...
              <form method="post" action="{{route('setups.student.class.update',$editData->id)}}" id="myForm">
...
<div class="form-group col-md-6" style="border-top: 30px;">
