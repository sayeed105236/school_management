          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
               ...
               <h3> Edit Shift
                <a class="btn btn-success float-right btn-sm" href="{{route('setups.shift.view')}}"><i class="fa fa-list"></i>Shift List</a>
              ...
              <form method="post" action="{{route('setups.shift.update',$editData->id)}}" id="myForm">
