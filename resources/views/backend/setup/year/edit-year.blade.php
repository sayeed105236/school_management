          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
               ...
               <h3> Edit Year
                <a class="btn btn-success float-right btn-sm" href="{{route('setups.year.view')}}"><i class="fa fa-list"></i>Year List</a>
              ...
              <form method="post" action="{{route('setups.year.update',$editData->id)}}" id="myForm">
